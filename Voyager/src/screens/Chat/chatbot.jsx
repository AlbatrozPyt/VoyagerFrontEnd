import {
  ...
  const chat = modelo.startChat({ history: historicoChat });
      ...
      setTimeout(async () => {
        ...
        await chat
          ...
          .catch((erro) => {
            setHistoricoChat([
              ...historicoChat,
              { id: Date.now(), texto: erro.response.data.trim() },
            ]);
          });
            ...
            <ChatSectionBox>
              ...
              {gerandoResposta ?
                <Image
                  ...
                  source={{ uri: "https://voyagerblobstorage.blob.core.windows.net/voyagercontainerblob/load_gif.webp" }}
                />
                : null}
            </ChatSectionBox>
